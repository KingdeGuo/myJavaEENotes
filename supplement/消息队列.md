...
- 与JMS的对比
  ...
  ![image-20210718224513342](https://raw.githubusercontent.com/KingdeGuo/myPictureBed/main/img_upload202107/18/224514-10723.png)

  - AMQP定义了线路层协议，而JMS定义的是API规范。
  - AMQP只支持byte[]，JMS支持五种消息类型
  - AMQP支持多种路由算法，而JMS只有两种。
...
- 基于erlang开发，并发能力强
- 优点
  - 可靠性、灵活的路由、扩展性、高可用性、支持多种协议、多语言客户端、易用的管理界面
